...
<html>
    <head>
        ...
        <title>Manage Car Tracking</title>
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Manage Car Tracking</h4>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box analytics-info">
                        <h3 class="box-title">Manage Car Tracking</h3>
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($arr=mysqli_fetch_array($result)) {
                                            ...
                                            <tbody>
                                                <tr>
                                                <td>$id</td>
                                                <td><img src='images/$image' style='max-width: 10%; border-radius: ;'></td>
                                                <td><a class='btn btn-danger' href='editcourse.php?id=$id'>edit</a></td>
                                                <td><a class='btn btn-danger' href='deletecourse.php?id=$id'>delete</a></td>
                                                </tr>
                                            </tbody>
