...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>G-Technology | Car Tracking form</title>
    <!-- Font Awesome -->
...
if (isset($_POST['submit'])) {
  ...
  if (empty($imagename)) {
      ...
      $query= "INSERT INTO cartracking(imagename) VALUES ('$imagename')";
                    ...
                    <ul class="navbar-nav ms-auto d-flex align-items-center">
                        <li>
                            <a class="profile-pic" href="#">
                                ...
                                class="img-circle"><span class="text-white font-medium">G-Technology</span>
                            </a>
                        </li>
                    </ul>
                </div>
