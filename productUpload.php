...
<head>
    ...
    <title>G-Technology | Product form</title>
...
if (isset($_POST["submit"])) {
    ...
    if (empty($name) or empty($price)  or empty($qty) or empty($code) or empty($desc) or empty($imagename)) {
        ...
        $sql = "INSERT INTO product(product_name,product_image,product_price,product_qty,product_code,product_desc) VALUES ('$name','$imagename','$price','$qty','$code','$desc')";
        $result = mysqli_query($con, $sql);
        $uploads = move_uploaded_file($tmp, $path);
                    ...
                    <div class="white-box analytics-info">
                        <h3 class="box-title">Add Image</h3>     
                          <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <textarea rows="" cols="" name="desc" class="form-control"></textarea>
