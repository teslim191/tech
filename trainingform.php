...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>G-Technology | training form</title>
    <!-- Font Awesome -->
...
if (isset($_POST["submit"])) {
    ...
    if (empty($name) or empty($price) or empty($description) or empty($imagename)) {
        ...
        $sql = "INSERT INTO course(name,price,description,image) VALUES ('$name','$price','$description','$imagename')";
        ...
        if ($result && $uploads) {
            ...
            <strong>Unable to add course</strong>
            <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
          </div>
            ";
        }
